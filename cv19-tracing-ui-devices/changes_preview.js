	...
	function loadChanges() {
		...
		function prepareChanges() {
			...
			if (usePreviewConnector()) {
				...
				oChanges = {
					changes: oResult,
					componentClassName: "covid19.ui.devicesmanagement.cv19-tracing-ui-devices"
				};
			}
		...
		return new Promise(function (resolve, reject) {
			$.ajax({
				...
				function isMTAChange(sPath) {
					...
					return sPath.startsWith("cv19-tracing-ui-devices") && sPath.indexOf("webapp/changes/") > 0 && isValidChangeFileExt(sPath);
				}
