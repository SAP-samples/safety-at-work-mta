		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#DevicesManagement-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"DevicesManagement-display": {
								"semanticObject": "DevicesManagement",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=covid19.ui.devicesmanagement.cv19-tracing-ui-devices",
									"url": sap.ui.require.toUrl("covid19/ui/devicesmanagement/cv19-tracing-ui-devices")
								}
							}
						}
					}
