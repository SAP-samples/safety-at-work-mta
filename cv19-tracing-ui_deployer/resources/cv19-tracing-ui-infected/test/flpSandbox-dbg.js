		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Manage Notifaction of Infection",
									"targetURL": "#ManageNotifactionofInfection-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ManageNotifactionofInfection-display": {
								"semanticObject": "ManageNotifactionofInfection",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=covid19.ui.infected.cv19-tracing-ui-infected",
									"url": sap.ui.require.toUrl("covid19/ui/infected/cv19-tracing-ui-infected")
								}
							}
						}
					}
