sap.ui.define([
	"sap/ui/test/Opa5",
	"covid19/ui/infected/cv19-tracing-ui-infected/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel",
	"sap/ui/core/routing/HashChanger",
	"covid19/ui/infected/cv19-tracing-ui-infected/test/flpSandbox",
	"sap/ui/fl/FakeLrepConnectorLocalStorage"
], function(Opa5, mockserver, ODataModel, HashChanger, flpSandbox, FakeLrepConnectorLocalStorage) {
	"use strict";

	return Opa5.extend("covid19.ui.infected.cv19-tracing-ui-infected.test.integration.arrangements.Startup", {
